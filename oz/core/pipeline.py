...
def build_parser():
    ap = argparse.ArgumentParser(description="Pipeline runner for Oz optical-electrical accuracy evaluation.")
...
def main(argv=None):
    ...
    if model.get("model_type") != "optical_phase_two_stage":
        raise ValueError("oz_only only supports model_type='optical_phase_two_stage'.")
